<div class="row well" style="margin:auto 0;">
    <div class="col-xs-3">
        ...
        <div class="panel panel-default">
            ...
            <ul class="list-group">
                <a href="?r=install/insone" class="list-group-item list-group-item-info"><span class="glyphicon glyphicon-copyright-mark"></span> &nbsp; 许可协议</a>
    ...
    <div class="col-xs-9">
        <div class="panel panel-default">
            ...
            <div class="panel-body" style="overflow-y:scroll;max-height:400px;line-height:20px;">
                <h2>版权所有(c)2016，8组成员 保留所有权利。 </h2>
                <h4 align="center"><font color="red">中国领土,寸土不让!!!</font></h4>
                <p>
                    感谢您选择微凉 - 微信公众平台自助开源引擎（以下简称WL，WL基于 PHP + MySQL的技术开发，全部源码开放。 <br />
                    为了使你正确并合法的使用本软件，请你在使用前务必阅读清楚下面的协议条款：
                </p>
                <p>
                    <strong>一、本授权协议适用且仅适用于微擎系统(WL, WeiLiang. 以下简称微凉)任何版本，微凉官方对本授权协议的最终解释权。</strong>
                </p>
                <p>
                    <strong>二、协议许可的权利 </strong>
                <ol>
                    <li>您可以在完全遵守本最终用户授权协议的基础上，将本软件应用于非商业用途，而不必支付软件版权授权费用。</li>
                    <li>您可以在协议规定的约束和限制范围内修改微凉源代码或界面风格以适应您的网站要求。</li>
        ...
        <form class="form-inline" role="form" action="index.php?r=install/instwo" method="post">
            <ul class="pager">
